...
@Component({
  selector: 'app-history-partner-behavior',
  templateUrl: './history-partner-behavior.component.html',
  styleUrls: ['./history-partner-behavior.component.scss']
})
export class HistoryPartnerBehaviorComponent implements OnInit {
  public tableList = [];
  public dateRange = [];
  public isDateRange = {};
