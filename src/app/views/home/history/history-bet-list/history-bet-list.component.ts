...
@Component({
  selector: 'app-history-bet-list',
  templateUrl: './history-bet-list.component.html',
  styleUrls: ['./history-bet-list.component.scss']
})
export class HistoryBetListComponent implements OnInit {
  public tableList  = [];
  public dateRange  = [];
  public page = {
    index: 1,
  ...
  public async getDataList() {
    ...
    const response = await this.api.Http({name: 'playerProject', data: {...this.searchData}});
