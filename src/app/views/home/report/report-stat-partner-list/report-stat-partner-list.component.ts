...
@Component({
  selector: 'app-report-stat-partner-list',
  templateUrl: './report-stat-partner-list.component.html',
  styleUrls: ['./report-stat-partner-list.component.scss']
})

export class ReportStatPartnerListComponent implements OnInit {
  public tableList = [];
  ...
  public getDataList() {
    ...
    this.api.Http({ name: 'partnerReportDayList', data: this.searchData }).then((res: any) => {
      if (res.success) {
