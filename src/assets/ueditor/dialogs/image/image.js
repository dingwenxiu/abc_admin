    ...
    UploadImage.prototype = {
        ...
        initUploader: function() {
            ...
            uploader.on('uploadBeforeSend', function(file, data, header) {
                ...
                const cookie =  JSON.parse(window.localStorage['user']);
                // header['Authorization'] = 'Bearer ' + window.localStorage['token'];
                // header['token'] = window.localStorage['token'];
                header['Authorization'] = 'Bearer ' + cookie.data['token'];
                header['token'] = cookie.data['token'];
            });
